...
**Project:** @plasius/graph-client-core (Plasius LTD)  
...
- **"Project"** means the @plasius/graph-client-core repositories and related materials owned or managed by **Plasius LTD**.
